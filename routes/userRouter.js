...
router.put('/update-user/:id', async (req, res) => {
  try {
    const { id } = req.params;
    const { name, pipeline, email, password, image, role, branch, permissions, delstatus, verified, products } = req.body;
    ...
    // Allow products to be set to null if explicitly provided as null in the payload
